     ...
     {/* Hero */}
      <section className="pt-36 sm:pt-44 pb-12 px-4 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #0f0f1a 0%, #13103a 60%, #1a1040 100%)' }}>
        <div className="container mx-auto max-w-3xl text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 uppercase" style={{ color: '#ffffff', fontFamily: "'Big Shoulders', 'Poppins', sans-serif", fontWeight: 900, WebkitTextStroke: '1.5px #ffffff', letterSpacing: '0.01em' }}>
            Contact Us
          </h1>
      ...
      <section className="px-4 pb-16">
        <div className="container mx-auto max-w-4xl grid grid-cols-1 sm:grid-cols-3 gap-6">
          <a
