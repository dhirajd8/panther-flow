            ...
            <div className="text-center space-y-6">
              ...
              <div className="flex flex-col items-center gap-4 pt-1 rise-up rise-up-delay-2">
                <Button
                  onClick={handleEnrollClick}
                  size="lg"
                  className="btn-join text-white text-lg px-8 py-6 rounded-full font-bold rise-up rise-up-delay-3"
                ...
                <div className="flex flex-col sm:flex-row gap-3 rise-up rise-up-delay-4">
                  <div className="flex items-center gap-3 px-5 py-3 rounded-2xl" style={{
                    ...
                    <div>
                      <div className="text-sm font-bold" style={{ fontFamily: 'Poppins, sans-serif', color: '#0f0f0f' }}>45+ Students</div>
                      <div className="text-xs font-semibold" style={{ fontFamily: 'Poppins, sans-serif', color: '#FF5A09' }}>Trained & Running Ads</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 px-5 py-3 rounded-2xl" style={{
                    ...
                    <div>
                      <div className="text-sm font-bold" style={{ fontFamily: 'Poppins, sans-serif', color: '#0f0f0f' }}>Limited Seats</div>
                      <div className="text-xs font-semibold" style={{ fontFamily: 'Poppins, sans-serif', color: '#FF5A09' }}>1st August Batch</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="md:col-span-3 space-y-5">
                  ...
                  <div className="space-y-4" style={{ fontFamily: 'Poppins, sans-serif', color: '#ffffff' }}>
                    <p className="text-base leading-relaxed">
                      Internet वर मार्केटिंग शिकवणारे भरपूर courses आहेत, पण <strong className="gradient-text">मराठीत, सोप्या भाषेत आणि परवडणाऱ्या किमतीत</strong> शिकवणारा course सापडणं अवघड आहे. हीच गरज लक्षात घेऊन Panther Flow सुरू केलं — जिथे प्रत्येक concept मराठीत, उदाहरणांसह समजावून सांगितलं जातं. मी धाराशिवचा असून गेली काही वर्षं Performance Marketing मध्ये काम करतोय, आणि हे सगळं ज्ञान थेट, <strong className="gradient-text">live सेशन्सच्या माध्यमातून शिकवतो</strong> — recorded videos नाही.
                    </p>
                    <p className="text-base leading-relaxed">
                      पुणे-मुंबईच्या Digital Marketing Institutes ची fees सगळ्यांना परवडणारी नसते. लवकर job हवी म्हणून admission घेतली जाते, पण course संपल्यावरही skills आणि confidence तयार होत नाही. हाच problem सोडवण्यासाठी Panther Flow आहे — <strong className="gradient-text">affordable किमतीत, practical पद्धतीने, मराठीत</strong> शिकवणारा Meta Ads course.
                    </p>
                  </div>
             ...
             <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-4 rise-up rise-up-delay-1" style={{ fontFamily: 'Poppins, sans-serif', color: '#ffffff', lineHeight: '1.25' }}>
              ...
              <div className="pt-2">
                <Button 
                  onClick={handleEnrollClick}
                  size="lg"
                  className="btn-join text-white text-xl px-12 py-8 rounded-full font-bold btn-blue btn-animated-border rise-up rise-up-delay-3"
  ...
  <div className="container mx-auto max-w-4xl text-center relative z-10">
    ...
    <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-[70] w-14 h-14 rounded-full flex items-center justify-center shadow-2xl whatsapp-float-btn"
        style={{ background: 'linear-gradient(135deg, #25D366 0%, #128C7E 100%)' }}
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-7 h-7" fill="#ffffff">
