...
const Home = () => {
  ...
  const openWhatsApp = () => {
    window.open('https://wa.link/kzhidt', '_blank');
  };
  ...
  return (
    <div className="min-h-screen" style={{ 
        ...
        <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md border-b border-white/20 shadow-lg" style={{
          ...
          <div className="container mx-auto px-4 py-4 flex justify-between items-center gap-4">
            ...
            <Button 
              ...
              className="bg-white/90 text-[#17245a] hover:bg-white font-semibold px-6 transition-all duration-300 hover:scale-105"
              style={{ fontFamily: 'Google Sans, sans-serif' }}
      ...
      <button
        ...
        className="fixed bottom-6 left-6 z-50 group flex items-center gap-3 px-5 py-4 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 animate-pulse-glow"
        style={{
      ...
      >
        ...
        <span className="text-white font-semibold hidden sm:block group-hover:tracking-wide transition-all">
          WhatsApp Us
        </span>
      </button>
    </div>
