              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6 rise-up rise-up-delay-2">
                ...
                <div className="flex flex-col items-start gap-1 rise-up rise-up-delay-4">
                  <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <span className="text-sm" style={{ fontFamily: 'Poppins, sans-serif', color: '#1e293b' }}><span style={{ background: 'linear-gradient(135deg, #4F46E5 0%, #7C3AED 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', display: 'inline-block' }}>✅</span> 45+ Students Trained & Running Ads</span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-600">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="rounded-2xl p-6 relative overflow-hidden min-h-[220px] flex flex-col justify-end" style={{ background: 'linear-gradient(135deg, rgba(79,70,229,0.1) 0%, rgba(124,58,237,0.1) 100%)', border: '1.5px solid rgba(139,92,246,0.4)', backdropFilter: 'blur(10px)', webkitBackdropFilter: 'blur(10px)' }}>
                ...
                <div className="flex-1 flex items-center justify-center py-4">
                  <div className="relative">
                    <div className="w-16 h-12 rounded-t-xl flex items-center justify-center" style={{ background: 'rgba(255,255,255,0.2)' }}>
                      <span className="text-white text-xs font-bold">MY SHOP</span>
                    </div>
                    <div className="w-20 h-8 rounded-b-sm" style={{ background: 'rgba(255,255,255,0.1)' }}></div>
                    <div className="absolute -bottom-2 right-0 flex gap-1">
                      {[1,2,3].map(i => <div key={i} className="w-1.5 rounded-t" style={{ height: `${i*8}px`, background: 'rgba(255,255,255,0.5)' }}></div>)}
                    </div>
                  </div>
                </div>
              ...
              <div className="rounded-2xl p-6 relative overflow-hidden min-h-[220px] flex flex-col justify-end" style={{ background: 'linear-gradient(135deg, rgba(124,58,237,0.1) 0%, rgba(79,70,229,0.1) 100%)', border: '1.5px solid rgba(139,92,246,0.4)', backdropFilter: 'blur(10px)', webkitBackdropFilter: 'blur(10px)' }}>
                ...
                <div className="flex-1 flex items-center justify-center py-4">
                  <div className="relative">
                    <div className="w-20 h-12 rounded-t-lg border-2 flex items-center justify-center" style={{ background: 'rgba(255,255,255,0.1)', borderColor: 'rgba(255,255,255,0.3)' }}>
                      <div className="w-12 h-6 rounded" style={{ background: 'rgba(129,1,0,0.8)' }}>
                        <div className="flex gap-1 p-1">
                          {[1,2,3].map(i => <div key={i} className="h-1 rounded" style={{ width: `${i*10}px`, background: 'rgba(255,255,255,0.7)' }}></div>)}
                        </div>
                      </div>
                    </div>
                    <div className="w-24 h-2 rounded-b-lg" style={{ background: 'rgba(255,255,255,0.2)' }}></div>
                    <div className="absolute -right-6 top-0 flex flex-col gap-1">
                      {['?','?','?'].map((q,i) => <div key={i} className="w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold" style={{ background: 'rgba(255,255,255,0.2)', color: 'white' }}>{q}</div>)}
                    </div>
                  </div>
                </div>
              ...
              <div className="rounded-2xl p-6 relative overflow-hidden min-h-[220px] flex flex-col justify-end" style={{ background: 'linear-gradient(135deg, rgba(79,70,229,0.1) 0%, rgba(124,58,237,0.1) 100%)', border: '1.5px solid rgba(139,92,246,0.4)', backdropFilter: 'blur(10px)', webkitBackdropFilter: 'blur(10px)' }}>
                ...
                <div className="flex-1 flex items-center justify-center py-4">
                  <div className="relative">
                    <div className="w-16 h-12 rounded flex items-end justify-center gap-1">
                      <div className="w-4 h-10 rounded-t" style={{ background: 'rgba(255,255,255,0.3)' }}></div>
                      <div className="w-4 h-8 rounded-t" style={{ background: 'rgba(255,255,255,0.2)' }}></div>
                      <div className="w-4 h-12 rounded-t" style={{ background: 'rgba(255,255,255,0.4)' }}></div>
                    </div>
                    <div className="absolute -bottom-2 -right-4 w-6 h-6 rounded-full flex items-center justify-center" style={{ background: 'rgba(255,200,0,0.8)' }}>
                ...
                <div className="flex-1 flex items-center justify-center py-4">
                  <div className="flex items-end gap-2">
                    {[40,60,45,80,55,90].map((h,i) => (
                      <div key={i} className="w-3 rounded-t" style={{ height: `${h}%`, maxHeight: '60px', minHeight: '15px', background: i === 5 ? 'rgba(255,255,255,0.9)' : 'rgba(255,255,255,0.3)' }}></div>
                    ))}
                  </div>
                </div>
                <h3 className="text-lg font-bold text-white mb-1" style={{ fontFamily: 'Poppins, sans-serif' }}>Marketers</h3>
                <p className="text-sm" style={{ color: 'rgba(255,255,255,0.8)', fontFamily: 'Poppins, sans-serif' }}>तुमचे डिजिटल मार्केटिंग स्किल्स वाढवायचे आहेत?</p>
              </div>
  ...
  <div className="container mx-auto max-w-4xl text-center relative z-10">
    ...
    <div className="grid grid-cols-2 gap-4 sm:flex sm:flex-wrap sm:justify-center sm:gap-6">
      ...
      <a href="https://www.facebook.com/profile.php?id=61590443666474" target="_blank" rel="noopener noreferrer"
        ...
        <span className="font-bold text-white" style={{ fontFamily: 'Poppins, sans-serif' }}>Facebook</span>
      </a>
      ...
      <a href="https://www.instagram.com/_pantherflow/" target="_blank" rel="noopener noreferrer"
        ...
        <span className="font-bold text-white" style={{ fontFamily: 'Poppins, sans-serif' }}>Instagram</span>
      </a>
      ...
      <a href="https://www.linkedin.com/company/panther-flow/" target="_blank" rel="noopener noreferrer"
        ...
        <span className="font-bold text-white" style={{ fontFamily: 'Poppins, sans-serif' }}>LinkedIn</span>
      </a>
      ...
      <a href="https://www.youtube.com/@DhirajDayanand" target="_blank" rel="noopener noreferrer"
        ...
        <span className="font-bold text-white" style={{ fontFamily: 'Poppins, sans-serif' }}>YouTube</span>
      </a>
